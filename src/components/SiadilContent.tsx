      ...
      <div className="p-4 lg:p-8">
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">SIADIL</h1>
              <p className="text-gray-600 dark:text-gray-300 mb-2">Sistem Arsip Digital</p>
              ...
              <nav className="flex items-center space-x-3 text-sm">
                ...
                <div className="flex items-center space-x-2 bg-white dark:bg-gray-800 rounded-lg px-3 py-2 border border-gray-200 dark:border-gray-700 ">
                  ...
                  <span className="text-gray-700 dark:text-gray-300 font-normal">Root</span>
                </div>
              </nav>
            </div>
          </div>
            ...
            <div className="flex flex-col space-y-5">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 ">
                ...
                <div className="flex items-center space-x-2">
                  {/* SVG Lock Icon */}
                  <svg 
                    className="h-5 w-5 text-gray-900 dark:text-gray-400" 
                    width="24" 
                    height="24" 
                    viewBox="0 0 24 24" 
                    strokeWidth="2" 
                  ...
                  {/* Teks "Personal" */}
                  <p className="font-semibold text-gray-900 dark:text-white text-lg">Personal</p>
                </div>
                
                {/* Baris kedua: Teks ID */}
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">1990123</p>
              </div>
              </div>

              {/* Reminders Section */}
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Reminders</h3>
                <div className="space-y-3">
                  ...
                  <div className="bg-red-700 text-white rounded-xl p-4 ">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-sm mb-1 text-white">SSL</p>
