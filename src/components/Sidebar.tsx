...
const Sidebar = ({
  ...
  return (
    <div
      className="bg-white min-h-screen border-r border-gray-100 transition-all duration-300 relative w-full h-full"
      ...
      <div
        ...
        } py-3 border-gray-100 transition-all duration-300`}>
        <div
          ...
          <div
            ...
            } bg-red-500 rounded-full flex items-center justify-center transition-all duration-300`}>
            ...
            <li>
              <button
                ...
                className={`w-full flex items-center ${
                  ...
                  activeMenu === "Home" ? "text-white" : "text-gray-950"
                }`}
                style={
                  activeMenu === "Home" ? { backgroundColor: "#01793b" } : {}
                }
            ...
            <li>
              <button
                ...
                className={`w-full flex items-center ${
                  ...
                  activeMenu === "Profile" ? "text-white" : "text-gray-950"
                }`}
                style={
                  activeMenu === "Profile" ? { backgroundColor: "#01793b" } : {}
                }
            ...
            <li>
              <button
                ...
                className={`w-full flex items-center ${
                  ...
                  activeMenu === "Employment" ? "text-white" : "text-gray-950"
                }`}
                style={
            ...
            <li>
              <button
                ...
                className={`w-full flex items-center ${
                  ...
                  activeMenu === "Kehadiran" ? "text-white" : "text-gray-950"
                }`}
                style={
                ...
                title={
                  isCollapsed ? "Kehadiran, Koreksi, Cuti, dan Dinas" : ""
                }>
                <svg
                  className={`${
                    isCollapsed ? "w-6 h-6" : "w-5 h-5"
            ...
            <li>
              <button
                ...
                className={`w-full flex items-center ${
                  ...
                  activeMenu === "SIADIL" ? "text-white" : "text-gray-950"
                }`}
                style={
                  activeMenu === "SIADIL" ? { backgroundColor: "#01793b" } : {}
                }
