  ...
  return (
    <>
      ...
      <div
        ...
        style={{...style, animation: 'fadeIn 0.3s cubic-bezier(0.16, 1, 0.3, 1) forwards', opacity: 0}}>
      <div className="p-3">
        <div className="px-2 py-2 text-left bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-lg mb-2">
          <p className="text-sm font-bold text-emerald-700 dark:text-emerald-300 tracking-wide">
            ID #{documentId}
          </p>
        </div>
            ...
            return (
              <li key={index} style={{ animationDelay: `${index * 40}ms` }}>
                <button
                  ...
                  style={{ animation: `fadeIn 0.3s cubic-bezier(0.16, 1, 0.3, 1) forwards ${index * 40}ms both` }}>
