      ...
      >
        ...
        <div className="p-6 border-t dark:border-gray-700 space-y-4 flex-shrink-0">
          ...
          <button
            ...
            className="w-full px-4 py-2 text-sm font-medium text-white bg-[#0F9D58] rounded-md hover:bg-[#0C8A4D] shadow-sm hover:shadow-md transition-all"
          >
            Add Contributor
          </button>
        </div>
        ...
        <div className="flex justify-end p-4 bg-gray-50 dark:bg-gray-800/50 border-t dark:border-gray-600 rounded-b-lg flex-shrink-0">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-semibold text-white bg-[#0F9D58] rounded-md hover:bg-[#0C8A4D] shadow-sm hover:shadow-md transition-all"
          >
            Save Changes
          </button>
        </div>
